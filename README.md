...
03/11/24 :
Comprendre les concepts fondamentaux (threads et mutex)

Au début, j’ai dû comprendre ce qu’est un thread et comment il fonctionne. 
En résumé, un thread est une unité d’exécution légère qui permet d’exécuter plusieurs tâches en parallèle dans un même processus. 

Cela signifie que chaque philosophe est représenté par un thread, ce qui permet à chacun d’agir indépendamment.
